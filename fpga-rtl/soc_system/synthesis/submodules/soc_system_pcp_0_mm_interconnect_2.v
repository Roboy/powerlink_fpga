...
module soc_system_pcp_0_mm_interconnect_2 (
		...
		output wire [14:0] slow_bridge_s0_address,                        //                          slow_bridge_s0.address
	...
	wire  [15:0] slow_bridge_s0_agent_m0_address;                                   // slow_bridge_s0_agent:m0_address -> slow_bridge_s0_translator:uav_address
	...
	wire  [90:0] slow_bridge_s0_agent_rf_source_data;                               // slow_bridge_s0_agent:rf_source_data -> slow_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [90:0] slow_bridge_s0_agent_rsp_fifo_out_data;                            // slow_bridge_s0_agent_rsp_fifo:out_data -> slow_bridge_s0_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> slow_bridge_s0_agent:cp_data
	...
	wire  [15:0] powerlink_led_s1_agent_m0_address;                                 // POWERLINK_LED_s1_agent:m0_address -> POWERLINK_LED_s1_translator:uav_address
	...
	wire  [90:0] powerlink_led_s1_agent_rf_source_data;                             // POWERLINK_LED_s1_agent:rf_source_data -> POWERLINK_LED_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] powerlink_led_s1_agent_rsp_fifo_out_data;                          // POWERLINK_LED_s1_agent_rsp_fifo:out_data -> POWERLINK_LED_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> POWERLINK_LED_s1_agent:cp_data
	...
	wire  [15:0] benchmark_pio_s1_agent_m0_address;                                 // benchmark_pio_s1_agent:m0_address -> benchmark_pio_s1_translator:uav_address
	...
	wire  [90:0] benchmark_pio_s1_agent_rf_source_data;                             // benchmark_pio_s1_agent:rf_source_data -> benchmark_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] benchmark_pio_s1_agent_rsp_fifo_out_data;                          // benchmark_pio_s1_agent_rsp_fifo:out_data -> benchmark_pio_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> benchmark_pio_s1_agent:cp_data
	...
	wire  [89:0] slow_bridge_s0_agent_rp_data;                                      // slow_bridge_s0_agent:rp_data -> router_002:sink_data
	...
	wire  [89:0] powerlink_led_s1_agent_rp_data;                                    // POWERLINK_LED_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [89:0] benchmark_pio_s1_agent_rp_data;                                    // benchmark_pio_s1_agent:rp_data -> router_004:sink_data
	...
	soc_system_pcp_0_mm_interconnect_2_router router (
	...
	soc_system_pcp_0_mm_interconnect_2_router_001 router_001 (
	...
	soc_system_pcp_0_mm_interconnect_2_router_001 router_002 (
	...
	soc_system_pcp_0_mm_interconnect_2_router_001 router_003 (
	...
	soc_system_pcp_0_mm_interconnect_2_router_001 router_004 (
	...
	soc_system_pcp_0_mm_interconnect_2_router_001 router_005 (
	...
	soc_system_pcp_0_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk50_clk_clk),                                 //        clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk50_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_cmd_mux cmd_mux_001 (
		.clk                 (clk50_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_cmd_mux cmd_mux_002 (
		.clk                 (clk50_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_cmd_mux cmd_mux_003 (
		.clk                 (clk50_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_cmd_mux cmd_mux_004 (
		.clk                 (clk50_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_rsp_demux rsp_demux (
		.clk                (clk50_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_rsp_demux rsp_demux_001 (
		.clk                (clk50_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_rsp_demux rsp_demux_002 (
		.clk                (clk50_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_rsp_demux rsp_demux_003 (
		.clk                (clk50_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_rsp_demux rsp_demux_004 (
		.clk                (clk50_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_pcp_0_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk50_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
